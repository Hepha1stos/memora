...
<Heading tag="h4" class="text-center text-2xl font-semibold mb-4 text-primary-600">Create a new Flashcard</Heading>

<p class="text-black text-base font-medium mb-2 text-wrap">
  Create a new flashcard by entering your question and answer!
</p>
